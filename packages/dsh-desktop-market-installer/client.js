window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // Local brand copy: this package runs inside the Harness renderer and
    // cannot import src/shared/brand.ts. Keep in sync with that file.
    const BRAND_NAME = 'Aura智能工作台'
    ...
    const en = {
      nav: 'Plugin market',
      title: 'Plugin market',
      intro: `Install dsh-market to browse, search, install, and manage community plugins inside ${BRAND_NAME}.`,
      community: `dsh-market is maintained by its community. Installing and using community plugins requires network access, and those plugins are not reviewed by ${BRAND_NAME}.`,
      version: 'Recommended version',
      install: 'Install plugin market',
      installing: 'Installing plugin market…',
      installingHint: `This can take a few minutes. Keep ${BRAND_NAME} open while pnpm downloads and configures the plugin.`,
      ...
      managementIntro: `Manage the optional dsh-market integration installed by ${BRAND_NAME}.`,
    ...
    const zh = {
      nav: '插件市场',
      title: '插件市场',
      intro: `安装 dsh-market，在 ${BRAND_NAME} 内浏览、搜索、安装并管理社区插件。`,
      community: `dsh-market 由社区维护。安装和使用社区插件需要联网，这些插件不由 ${BRAND_NAME} 审核。`,
      version: '推荐版本',
      install: '安装插件市场',
      installing: '正在安装插件市场…',
      installingHint: `下载和配置可能需要几分钟，请保持 ${BRAND_NAME} 处于打开状态。`,
      installed: '插件市场已安装',
      ...
      managementTab: '插件市场',
      managementIntro: `管理由 ${BRAND_NAME} 安装的可选 dsh-market 集成。`,

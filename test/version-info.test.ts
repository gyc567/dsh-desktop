...
describe('desktop version information', () => {
  ...
  it('explains that Harness updates arrive with Desktop', () => {
    ...
    expect(aboutDetail('0.1.1', '0.1.0-rc.8', 'en')).toContain(
      'Harness is updated with Aura智能工作台.'
    )
    expect(aboutDetail('0.1.1', '0.1.0-rc.8', 'zh')).toContain('Eric | 微信：360369487')
    expect(aboutDetail('0.1.1', '0.1.0-rc.8', 'en')).toContain('Eric | 微信：360369487')
  })
})
